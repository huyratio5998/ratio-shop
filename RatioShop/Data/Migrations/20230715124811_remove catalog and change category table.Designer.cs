...
namespace RatioShop.Data.Migrations
{
    ...
    [Migration("20230715124811_remove catalog and change category table")]
    partial class removecatalogandchangecategorytable
    {
            ...
            modelBuilder.Entity("RatioShop.Data.Models.Category", b =>
                {
                    b.HasOne("RatioShop.Data.Models.Category", "ParentCategory")
                        .WithOne()
                        .HasForeignKey("RatioShop.Data.Models.Category", "ParentId");
