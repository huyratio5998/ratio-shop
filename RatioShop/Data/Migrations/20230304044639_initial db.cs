        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductFriendlyName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductRawName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantCart", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVariantCart_ProductVariant_ProductVariantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantStock", x => new { x.StockId, x.ProductVariantId });
                    table.ForeignKey(
                        name: "FK_ProductVariantStock_ProductVariant_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductVariantStock_Stock_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductVariantCartId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProductVariantCartId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantCart_ProductVariantId",
                table: "ProductVariantCart",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantStock_ProductVariantId",
